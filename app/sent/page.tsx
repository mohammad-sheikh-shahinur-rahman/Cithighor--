...
import { Search, Filter, Trash2, Star, Archive, SortAsc, SortDesc, Tag, User, Calendar, Clock } from "lucide-react"
      ...
      <main className="flex-1 container mx-auto p-4 md:p-6">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
            <h1 className="text-2xl font-serif font-bold text-amber-800">পাঠানো</h1>
              ...
              <Card className="border-amber-200">
                <CardContent className="p-6">
                  {loading ? (
                    ...
                    <div className="text-center py-8 text-amber-700">কোন পাঠানো চিঠি পাওয়া যায়নি।</div>
                  ) : (
